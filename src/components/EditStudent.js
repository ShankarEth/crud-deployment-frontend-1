...
function EditStudent() 
{
    ...
    const {id} = useParams();
    useEffect(()=>{
        Axios.get("https://crud-deployment1-o7ow.onrender.com/students/update-student/" + id)
        .then((res)=>{
            if(res.status === 200){
    ...
    const handleSubmit = () =>{
        ...
        Axios.put("https://crud-deployment1-o7ow.onrender.com/students/update-student/"+ id, data)
        .then((res)=>{
            if(res.status === 200){
